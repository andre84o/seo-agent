...
import { Activity, TrendingUp, CheckCircle2, AlertTriangle, Sparkles, Clock, Download, FileText, Lightbulb, History, XCircle, Loader2, PlayCircle, AlertCircle, BarChart3, ExternalLink, Settings as Settings$1, CheckCircle, EyeOff, Eye, Save, Key, Plus, Trash2, Link, LayoutDashboard, ListTodo, ChevronDownIcon, CheckIcon, ChevronUpIcon, TrendingDown, Play, X, Hash, Edit, Check, Copy, XIcon } from 'lucide-react';
...
function Dashboard({ refreshKey }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsx("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: [...Array(4)].map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-32" }, i)) }),
      /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-7", children: [
        /* @__PURE__ */ jsx(Skeleton, { className: "h-80 col-span-4" }),
        /* @__PURE__ */ jsx(Skeleton, { className: "h-80 col-span-3" })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxs(Card, { className: "hover:shadow-lg transition-shadow", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold", children: (stats == null ? void 0 : stats.totalPages) || 0 }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Monitored URLs" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-sm font-medium", children: "Average Score" }),
          /* @__PURE__ */ jsx(TrendingUp, { className: "h-4 w-4 text-green-600" })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold", children: (stats == null ? void 0 : stats.avgScore) || 0 }),
          /* @__PURE__ */ jsx("div", { className: "flex items-center text-xs text-muted-foreground", children: (stats == null ? void 0 : stats.scoreChange) && stats.scoreChange > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          ] }) : /* @__PURE__ */ jsx("span", { children: "vs last week" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-sm font-medium", children: "Active Tasks" }),
          /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-orange-600" })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold", children: (stats == null ? void 0 : stats.activeTasks) || 0 }),
      ...
      /* @__PURE__ */ jsxs(Card, { className: "hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-sm font-medium", children: "Flagged Issues" }),
          /* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4 text-red-600" })
        ] }),
        /* @__PURE__ */ jsxs(CardContent, { children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-red-600", children: (stats == null ? void 0 : stats.flaggedIssues) || 0 }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Needs attention" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxs(Card, { className: "border-dashed hover:border-solid hover:shadow-md transition-all", children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Sparkles, { className: "h-5 w-5 text-purple-600" }),
            "AI Suggestions"
          ] }),
        ...
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Button, { className: "w-full", variant: "outline", children: "View All Suggestions" }) })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "border-dashed hover:border-solid hover:shadow-md transition-all", children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: (stats == null ? void 0 : stats.lastRun) ? new Date(stats.lastRun).toLocaleDateString("sv-SE", {
            year: "numeric",
            month: "short",
            day: "numeric",
            hour: "2-digit",
        ...
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Button, { className: "w-full", variant: "outline", children: "View History" }) })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "border-dashed hover:border-solid hover:shadow-md transition-all", children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Button, { className: "w-full", variant: "outline", children: "Review Issues" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Quick Overview" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Your SEO performance at a glance" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: "Pages Monitored" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Total URLs tracked" })
          ] }),
          /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "text-lg", children: (stats == null ? void 0 : stats.totalPages) || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: "Average Performance" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Overall score" })
          ] }),
          /* @__PURE__ */ jsxs(
            Badge,
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium", children: "Tasks Progress" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Completed vs Total" })
          ] }),
    ...
    /* @__PURE__ */ jsxs(Card, { className: "border-dashed", children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxs(CardTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-2xl", children: "\u{1F916}" }),
          " AI SEO Analysis"
        ] }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Get AI-powered insights and recommendations for any page" })
      ] }),
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsx(Button, { onClick: runAnalysis, disabled: loading || !url, className: "px-8", children: loading ? "Analyzing..." : "Analyze" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx("label", { htmlFor: "createTasks", className: "text-sm text-gray-600", children: "Skapa automatiskt tasks fr\xE5n AI-f\xF6rslag" })
        ] }),
        error && /* @__PURE__ */ jsx(Card, { className: "border-destructive bg-destructive/10", children: /* @__PURE__ */ jsx(CardContent, { className: "pt-4", children: /* @__PURE__ */ jsx("p", { className: "text-destructive", children: error }) }) })
      ] })
    ] }),
    analysis && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsx(Card, { className: "border-primary/20 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20", children: /* @__PURE__ */ jsx(CardContent, { className: "pt-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center p-6 bg-white dark:bg-slate-900 rounded-lg shadow-sm", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("div", { className: "text-sm text-muted-foreground mt-2", children: "AI Score" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-lg mb-2", children: "Summary" }),
          /* @__PURE__ */ jsx("p", { className: "text-muted-foreground leading-relaxed", children: analysis.summary })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: "Detailed Analysis" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Explore AI-generated recommendations and insights" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs(Tabs, { defaultValue: "suggestions", children: [
          /* @__PURE__ */ jsxs(TabsList, { children: [
            /* @__PURE__ */ jsxs(TabsTrigger, { value: "suggestions", children: [
              "F\xF6rslag (",
              analysis.suggestions.length,
              ")"
            ] }),
            /* @__PURE__ */ jsx(TabsTrigger, { value: "titles", children: "Title-f\xF6rslag" }),
            /* @__PURE__ */ jsx(TabsTrigger, { value: "meta", children: "Meta Description" }),
            /* @__PURE__ */ jsx(TabsTrigger, { value: "keywords", children: "S\xF6kord" }),
            analysis.faqSuggestions && /* @__PURE__ */ jsx(TabsTrigger, { value: "faq", children: "FAQ" })
          ] }),
          /* @__PURE__ */ jsx(TabsContent, { value: "suggestions", className: "space-y-3", children: analysis.suggestions.map((suggestion, idx) => /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-4", children: [
            /* @__PURE__ */ jsx("div", { className: "flex items-start justify-between mb-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(Badge, { variant: getPriorityColor(suggestion.priority), children: suggestion.priority }),
              /* @__PURE__ */ jsx(Badge, { variant: "outline", children: suggestion.category })
            ] }) }),
            /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-2", children: suggestion.suggestion }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mb-2", children: suggestion.reasoning }),
            /* @__PURE__ */ jsxs("div", { className: "text-sm", children: [
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: "F\xF6rv\xE4ntad effekt:" }),
              " ",
              /* @__PURE__ */ jsx("span", { className: "text-green-600", children: suggestion.expectedImpact })
            ] }),
            suggestion.implementation && /* @__PURE__ */ jsxs("details", { className: "mt-2", children: [
              /* @__PURE__ */ jsx("summary", { className: "text-sm font-medium cursor-pointer text-blue-600", children: "Implementeringsdetaljer" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mt-1 pl-4", children: suggestion.implementation })
            ] })
          ] }) }, idx)) }),
          /* @__PURE__ */ jsx(TabsContent, { value: "titles", className: "space-y-2", children: analysis.titleSuggestions.map((title, idx) => /* @__PURE__ */ jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsx(TabsContent, { value: "meta", className: "space-y-2", children: analysis.metaDescriptionSuggestions.map((meta, idx) => /* @__PURE__ */ jsxs(
            "div",
            {
              className: "p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer",
              children: [
                /* @__PURE__ */ jsx("div", { className: "text-sm", children: meta }),
                /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-500 mt-1", children: [
                  "L\xE4ngd: ",
                  meta.length,
                  " tecken"
          ...
          /* @__PURE__ */ jsxs(TabsContent, { value: "keywords", className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-2", children: "Prim\xE4ra s\xF6kord" }),
              /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: analysis.keywords.primary.map((kw, idx) => /* @__PURE__ */ jsx(Badge, { variant: "default", children: kw }, idx)) })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-2", children: "Sekund\xE4ra s\xF6kord" }),
              /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: analysis.keywords.secondary.map((kw, idx) => /* @__PURE__ */ jsx(Badge, { variant: "secondary", children: kw }, idx)) })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-2", children: "Long-tail varianter" }),
              /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: analysis.keywords.longTail.map((kw, idx) => /* @__PURE__ */ jsx(Badge, { variant: "outline", children: kw }, idx)) })
            ] })
          ] }),
          analysis.faqSuggestions && /* @__PURE__ */ jsx(TabsContent, { value: "faq", className: "space-y-3", children: analysis.faqSuggestions.map((faq, idx) => /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-4", children: [
            /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-2", children: faq.question }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: faq.answer })
          ] }) }, idx)) })
        ] }) })
      ] })
    ] })
...
function ExportData({ compact = false }) {
  ...
  if (compact) {
    return /* @__PURE__ */ jsxs(
      Button,
      {
        ...
        size: "sm",
        children: [
          /* @__PURE__ */ jsx(Download, { className: "mr-2 h-3 w-3" }),
          "Export"
        ]
      }
    );
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      ...
      /* @__PURE__ */ jsx(CardDescription, { children: "Export latest audit results and suggestions as CSV files for further analysis" })
    ] }),
...
function RecentRuns() {
  ...
  const getStatusBadge = (status) => {
    const variants = {
      running: { variant: "default", icon: PlayCircle, label: "RUNNING", className: "" },
      completed: { variant: "default", icon: CheckCircle2, label: "COMPLETED", className: "bg-green-600 hover:bg-green-700" },
      failed: { variant: "destructive", icon: XCircle, label: "FAILED", className: "" }
    };
    ...
    return /* @__PURE__ */ jsxs(Badge, { variant: config.variant, className: config.className, children: [
      /* @__PURE__ */ jsx(Icon2, { className: "h-3 w-3 mr-1" }),
      config.label
    ] });
  };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsx(CardDescription, { children: "Total Runs" }),
        /* @__PURE__ */ jsxs(CardTitle, { className: "text-4xl flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(History, { className: "h-8 w-8 text-blue-600" }),
          runs.length
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsx(CardDescription, { children: "Completed" }),
        /* @__PURE__ */ jsxs(CardTitle, { className: "text-4xl flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(CheckCircle2, { className: "h-8 w-8 text-green-600" }),
          runs.filter((r) => r.status === "completed").length
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsx(CardDescription, { children: "Failed" }),
        /* @__PURE__ */ jsxs(CardTitle, { className: "text-4xl flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(XCircle, { className: "h-8 w-8 text-red-600" }),
          runs.filter((r) => r.status === "failed").length
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-3", children: runs.length === 0 ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "text-center py-12 text-muted-foreground", children: 'No runs yet. Click "Run Agent" to start your first audit.' }) }) : runs.map((run) => /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxs("span", { className: "text-sm font-mono text-muted-foreground", children: [
          "Run #",
          run.run_id
        ] }),
      ...
      /* @__PURE__ */ jsxs(CardContent, { children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 text-sm", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Started" }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Duration" }),
            /* @__PURE__ */ jsx("p", { className: "font-medium", children: calculateDuration(run) })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Pages Checked" }),
            /* @__PURE__ */ jsx("p", { className: "font-medium", children: run.pages_checked })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Avg Score" }),
            /* @__PURE__ */ jsx("p", { className: "font-medium", children: run.avg_score ? run.avg_score.toFixed(1) : "N/A" })
          ] })
        ] }),
        run.error_message && /* @__PURE__ */ jsxs(Alert, { variant: "destructive", className: "mt-4", children: [
          /* @__PURE__ */ jsx(XCircle, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsx(AlertDescription, { children: run.error_message })
        ] })
      ] })
    ] }, run.run_id)) })
  ] });
...
function RunAgent({ onRunComplete, compact = false }) {
    ...
    return /* @__PURE__ */ jsx(
      Button,
      {
        ...
        children: isRunning ? /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx(PlayCircle, { className: "mr-2 h-3 w-3" }),
          "Run Agent"
        ] })
      }
    );
  ...
  return /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxs(CardTitle, { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(PlayCircle, { className: "h-6 w-6" }),
        "Run SEO Agent"
      ] }),
      /* @__PURE__ */ jsx(CardDescription, { children: "Start a manual SEO audit of your website" })
    ] }),
    /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "site-url", children: "Site URL *" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            id: "site-url",
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "sitemap-url", children: "Sitemap URL (optional)" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            id: "sitemap-url",
        ...
        /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Leave empty to auto-discover from robots.txt" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "max-pages", children: "Max Pages to Check" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            id: "max-pages",
      ...
      result && /* @__PURE__ */ jsxs(Alert, { children: [
        /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }),
        /* @__PURE__ */ jsx(AlertTitle, { children: "Run Completed Successfully" }),
        /* @__PURE__ */ jsx(AlertDescription, { children: /* @__PURE__ */ jsxs("div", { className: "mt-2 space-y-1 text-sm", children: [
          ...
          result.flaggedPages.length > 0 && /* @__PURE__ */ jsxs("p", { className: "text-orange-600 dark:text-orange-400", children: [
...
function ScoreOverview() {
  ...
  const getVitalBadge = (value, threshold, unit) => {
    if (value === null) return /* @__PURE__ */ jsx(Badge, { variant: "outline", children: "N/A" });
    const isGood = value <= threshold;
    return /* @__PURE__ */ jsxs(Badge, { variant: isGood ? "default" : "destructive", className: isGood ? "bg-green-600 hover:bg-green-700" : "", children: [
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsx(Skeleton, { className: "h-12" }),
      /* @__PURE__ */ jsx(Skeleton, { className: "h-64" })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxs(Card, { className: "hover:shadow-md transition-shadow", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
          /* @__PURE__ */ jsxs(CardDescription, { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(BarChart3, { className: "h-4 w-4" }),
            "Total Pages"
          ] }),
          /* @__PURE__ */ jsx(CardTitle, { className: "text-4xl", children: audits.length })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Monitored URLs" }) })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "hover:shadow-md transition-shadow", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
          /* @__PURE__ */ jsxs(CardDescription, { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx(CardTitle, { className: "text-4xl", children: audits.length > 0 ? (audits.reduce((sum, a) => sum + a.score, 0) / audits.length).toFixed(1) : "0" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Overall performance" }) })
      ] }),
      /* @__PURE__ */ jsxs(Card, { className: "hover:shadow-md transition-shadow", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
          /* @__PURE__ */ jsxs(CardDescription, { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx(CardTitle, { className: "text-4xl text-orange-600", children: flaggedAudits.length })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Need attention" }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid gap-4 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-base", children: "Score Distribution" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Pages grouped by performance score" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs(PieChart, { children: [
          /* @__PURE__ */ jsx(
            Pie,
            {
              ...
              fill: "#8884d8",
              dataKey: "count",
              children: scoreDistribution.map((entry, index) => /* @__PURE__ */ jsx(Cell, { fill: entry.fill }, `cell-${index}`))
            }
          ),
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { className: "text-base", children: "Core Web Vitals" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "Average vital metrics across all pages" })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", { className: "space-y-4 pt-4", children: vitalsData.map((vital) => /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: vital.name }),
            /* @__PURE__ */ jsx(Badge, { variant: vital.status === "good" ? "default" : "destructive", className: vital.status === "good" ? "bg-green-600" : "", children: vital.value })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "h-2 w-full bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsx(
            "div",
            {
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { className: "text-base", children: "Performance Comparison" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Best and worst performing pages" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs(Tabs, { defaultValue: "bottom", children: [
        /* @__PURE__ */ jsxs(TabsList, { className: "grid w-full grid-cols-2", children: [
          /* @__PURE__ */ jsx(TabsTrigger, { value: "bottom", children: "Lowest Scores" }),
          /* @__PURE__ */ jsx(TabsTrigger, { value: "top", children: "Highest Scores" })
        ] }),
        /* @__PURE__ */ jsx(TabsContent, { value: "bottom", className: "mt-4", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs(BarChart, { data: bottomPages, children: [
          /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3" }),
          /* @__PURE__ */ jsx(XAxis, { dataKey: "name", angle: -45, textAnchor: "end", height: 100 }),
          /* @__PURE__ */ jsx(YAxis, { domain: [0, 100] }),
          /* @__PURE__ */ jsx(Tooltip, {}),
          /* @__PURE__ */ jsx(Bar, { dataKey: "score", fill: "#ef4444" })
        ] }) }) }),
        /* @__PURE__ */ jsx(TabsContent, { value: "top", className: "mt-4", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxs(BarChart, { data: topPages, children: [
          /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3" }),
          /* @__PURE__ */ jsx(XAxis, { dataKey: "name", angle: -45, textAnchor: "end", height: 100 }),
          /* @__PURE__ */ jsx(YAxis, { domain: [0, 100] }),
          /* @__PURE__ */ jsx(Tooltip, {}),
          /* @__PURE__ */ jsx(Bar, { dataKey: "score", fill: "#22c55e" })
        ] }) }) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { className: "text-base", children: "Page Details" }),
        /* @__PURE__ */ jsx(CardDescription, { children: "Detailed metrics for each page" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs(Table, { children: [
        /* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
          /* @__PURE__ */ jsx(TableHead, { children: "URL" }),
          /* @__PURE__ */ jsx(TableHead, { className: "text-center", children: "Score" }),
          /* @__PURE__ */ jsx(TableHead, { className: "text-center", children: "LCP" }),
          /* @__PURE__ */ jsx(TableHead, { className: "text-center", children: "CLS" }),
          /* @__PURE__ */ jsx(TableHead, { className: "text-center", children: "INP" }),
          /* @__PURE__ */ jsx(TableHead, { className: "text-center", children: "Checked" })
        ] }) }),
        /* @__PURE__ */ jsx(TableBody, { children: displayedAudits.length === 0 ? /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, { colSpan: 6, className: "text-center py-12 text-muted-foreground", children: "No audits found. Run the agent to start monitoring." }) }) : displayedAudits.map((audit, index) => /* @__PURE__ */ jsxs(TableRow, { className: "hover:bg-muted/50", children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: /* @__PURE__ */ jsx("span", { className: `text-2xl font-bold ${getScoreColor(audit.score)}`, children: audit.score }) }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: getVitalBadge(audit.lcp, 2.5, "s") }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: getVitalBadge(audit.cls, 0.1, "") }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: getVitalBadge(audit.inp, 200, "ms") }),
          /* @__PURE__ */ jsx(TableCell, { className: "text-center text-sm text-muted-foreground", children: new Date(audit.created_at).toLocaleDateString("sv-SE", {
            year: "numeric",
            month: "2-digit",
            day: "2-digit"
          }).replace(/-/g, "/") })
...
function SEOTasks() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsx(Card, { className: "hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
        /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-gray-800 dark:text-gray-100", children: taskCounts.all }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Total Tasks" })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { className: "hover:shadow-md transition-shadow border-orange-200 dark:border-orange-800", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
        /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-orange-600", children: taskCounts.todo }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "To Do" })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { className: "hover:shadow-md transition-shadow border-blue-200 dark:border-blue-800", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
        /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-blue-600", children: taskCounts.in_progress }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "In Progress" })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { className: "hover:shadow-md transition-shadow border-green-200 dark:border-green-800", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
        /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold text-green-600", children: taskCounts.done }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "Completed" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxs(CardTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("span", { className: "text-xl", children: "\u{1F4CB}" }),
          " SEO Tasks"
        ] }),
        /* @__PURE__ */ jsx(CardDescription, { children: "This week's prioritized tasks and improvements" })
      ] }),
      /* @__PURE__ */ jsx(CardContent, { children: loading ? /* @__PURE__ */ jsx("div", { className: "text-center py-8 text-muted-foreground", children: "Loading tasks..." }) : /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Tabs, { defaultValue: "todo", onValueChange: (v) => setFilter(v), children: [
        /* @__PURE__ */ jsxs(TabsList, { className: "grid w-full grid-cols-4", children: [
          ...
          /* @__PURE__ */ jsxs(TabsTrigger, { value: "todo", children: [
            "To Do (",
            taskCounts.todo,
            ")"
          ] }),
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-6 space-y-3", children: filteredTasks.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
          "No tasks ",
          filter !== "all" && `with status "${filter}"`
        ] }) : filteredTasks.map((task) => /* @__PURE__ */ jsx(Card, { className: "hover:shadow-md hover:border-primary/50 transition-all", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-4", children: [
          /* @__PURE__ */ jsx("div", { className: "flex items-start justify-between mb-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsx(Badge, { variant: getPriorityColor(task.priority), children: task.priority }),
            task.task_type && /* @__PURE__ */ jsx(Badge, { variant: "outline", children: task.task_type }),
            task.ai_generated && /* @__PURE__ */ jsx(Badge, { variant: "secondary", children: "\u{1F916} AI" }),
            /* @__PURE__ */ jsx("span", { className: `px-2 py-1 rounded-full text-xs ${getStatusColor(task.status)}`, children: task.status })
          ] }) }),
          /* @__PURE__ */ jsx("h4", { className: "font-semibold mb-1", children: task.title }),
          task.page_url && /* @__PURE__ */ jsxs("div", { className: "text-sm text-gray-600 mb-2", children: [
            "\u{1F4C4} ",
            task.page_url,
            task.last_score !== void 0 && /* @__PURE__ */ jsxs("span", { className: "ml-2", children: [
              "(Score: ",
              task.last_score,
              ")"
            ] })
          ] }),
          task.description && /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600 mb-2", children: task.description }),
          task.expected_impact && /* @__PURE__ */ jsxs("div", { className: "text-sm mb-3", children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: "F\xF6rv\xE4ntad effekt:" }),
            " ",
            /* @__PURE__ */ jsx("span", { className: "text-green-600", children: task.expected_impact })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mt-3", children: [
            task.status === "todo" && /* @__PURE__ */ jsx(
              Button,
              {
                size: "sm",
                variant: "outline",
            ...
            task.status === "in_progress" && /* @__PURE__ */ jsx(
              Button,
              {
                size: "sm",
                variant: "default",
            ...
            task.status !== "done" && task.status !== "skipped" && /* @__PURE__ */ jsx(
              Button,
              {
                size: "sm",
                variant: "ghost",
...
function Settings() {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsx(Skeleton, { className: "h-32" }),
      /* @__PURE__ */ jsx(Skeleton, { className: "h-64" }),
      /* @__PURE__ */ jsx(Skeleton, { className: "h-64" })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxs(CardTitle, { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Settings$1, { className: "h-6 w-6" }),
        "Inst\xE4llningar"
      ] }),
      /* @__PURE__ */ jsx(CardDescription, { children: "Konfigurera webbplatsinst\xE4llningar och hantera sidor och nyckelord." })
    ] }) }),
    /* @__PURE__ */ jsx(Card, { className: "bg-amber-50 dark:bg-amber-950 border-amber-200", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
      /* @__PURE__ */ jsxs("h3", { className: "font-semibold mb-2 flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("i", { className: "bi bi-shield-lock text-amber-600" }),
      ...
      /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted-foreground mb-3", children: [
        ...
        /* @__PURE__ */ jsx("code", { className: "bg-amber-100 dark:bg-amber-900 px-2 py-1 rounded", children: ".env.local" }),
        " ist\xE4llet f\xF6r i databasen."
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "text-sm space-y-2 text-muted-foreground", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: "PSI_API_KEY" }),
          " - Google PageSpeed Insights API-nyckel (obligatorisk)"
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: "GSC_ACCESS_TOKEN" }),
          " - Google Search Console access token (valfritt)"
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: "GSC_CLIENT_ID" }),
          " - Google OAuth Client ID (valfritt)"
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: "GSC_CLIENT_SECRET" }),
          " - Google OAuth Client Secret (valfritt)"
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("strong", { className: "text-foreground", children: "GSC_REFRESH_TOKEN" }),
          " - Google OAuth Refresh Token (valfritt)"
        ] })
      ] })
    ] }) }),
    success && /* @__PURE__ */ jsxs(Alert, { className: "bg-green-50 dark:bg-green-950 border-green-200", children: [
      /* @__PURE__ */ jsx(CheckCircle, { className: "h-4 w-4 text-green-600" }),
      /* @__PURE__ */ jsx(AlertDescription, { className: "text-green-800 dark:text-green-200", children: success })
    ] }),
    error && /* @__PURE__ */ jsxs(Alert, { variant: "destructive", children: [
      /* @__PURE__ */ jsx(AlertCircle, { className: "h-4 w-4" }),
      /* @__PURE__ */ jsx(AlertDescription, { children: error })
      ...
      return /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-2xl", children: getSettingIcon(setting.setting_key) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: getSettingLabel(setting.setting_key) }),
              /* @__PURE__ */ jsx(CardDescription, { children: setting.description })
            ] })
          ] }),
          isSensitive && /* @__PURE__ */ jsxs(Badge, { variant: "secondary", children: [
            /* @__PURE__ */ jsx("i", { className: "bi bi-shield-lock me-1" }),
            "K\xE4nslig"
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: setting.setting_key, children: "V\xE4rde" }),
            /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mt-2", children: [
              ...
              isSensitive && /* @__PURE__ */ jsx(
                Button,
                {
                  onClick: () => toggleShowSensitive(setting.setting_key),
                  variant: "outline",
                  size: "icon",
                  children: showSensitive[setting.setting_key] ? /* @__PURE__ */ jsx(EyeOff, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Eye, { className: "h-4 w-4" })
                }
              )
            ] })
          ] }),
            ...
            /* @__PURE__ */ jsx(
              Button,
              {
                ...
                children: isSaving ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("i", { className: "bi bi-arrow-repeat animate-spin me-2" }),
                  "Sparar..."
                ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx(Key, { className: "h-6 w-6" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Hantera nyckelord" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "L\xE4gg till nyckelord manuellt f\xF6r att sp\xE5ra och optimera" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4 bg-slate-50 dark:bg-slate-900 rounded-lg space-y-3", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-sm", children: "L\xE4gg till nytt nyckelord" }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-3", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "new-keyword", children: "Nyckelord" }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "new-keyword",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "keyword-url", children: "URL" }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "keyword-url",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "target-density", children: "M\xE5l-densitet % (valfritt)" }),
              /* @__PURE__ */ jsx(
                Input,
                {
                  id: "target-density",
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: addingKeyword ? /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx("i", { className: "bi bi-arrow-repeat animate-spin me-2" }),
                "L\xE4gger till..."
              ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          loadingKeywords ? /* @__PURE__ */ jsx(Skeleton, { className: "h-20" }) : keywords.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground py-4", children: "Inga nyckelord tillagda \xE4nnu. L\xE4gg till ett nyckelord f\xF6r att b\xF6rja sp\xE5ra." }) : /* @__PURE__ */ jsx("div", { className: "space-y-2 max-h-96 overflow-y-auto", children: keywords.map((kw) => /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "font-medium", children: kw.keyword }),
                    /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "text-xs", children: kw.status })
                  ] }),
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx(Link, { className: "h-6 w-6" }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: "Hantera sidor" }),
          /* @__PURE__ */ jsx(CardDescription, { children: "L\xE4gg till sidor att \xF6vervaka och analysera" })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4 bg-slate-50 dark:bg-slate-900 rounded-lg space-y-3", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold text-sm", children: "L\xE4gg till ny sida" }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsx(
              Input,
              {
            ...
            /* @__PURE__ */ jsx(
              Button,
              {
                onClick: addPage,
                disabled: addingPage,
                children: addingPage ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("i", { className: "bi bi-arrow-repeat animate-spin me-2" }),
                  "L\xE4gger till..."
                ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx(Plus, { className: "h-4 w-4 mr-2" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          loadingPages ? /* @__PURE__ */ jsx(Skeleton, { className: "h-20" }) : pages.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground py-4", children: "Inga sidor tillagda \xE4nnu. L\xE4gg till en sida f\xF6r att b\xF6rja \xF6vervaka." }) : /* @__PURE__ */ jsx("div", { className: "space-y-2 max-h-96 overflow-y-auto", children: pages.map((page) => /* @__PURE__ */ jsxs(
            "div",
            {
              className: "flex items-center justify-between p-3 bg-white dark:bg-slate-800 border rounded-lg",
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsx("p", { className: "font-medium text-sm break-all", children: page.url }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 text-xs text-muted-foreground mt-1", children: [
                    page.senaste_score !== null && /* @__PURE__ */ jsxs("span", { children: [
                      "Score: ",
                      page.senaste_score
                    ] }),
    ...
    /* @__PURE__ */ jsx(Card, { className: "bg-blue-50 dark:bg-blue-950 border-blue-200", children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
      /* @__PURE__ */ jsxs("h3", { className: "font-semibold mb-3 flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("i", { className: "bi bi-info-circle" }),
        "Setup-guide"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-4 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 p-3 rounded-lg", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-semibold text-foreground mb-2", children: "1. Konfigurera API-nycklar i .env.local" }),
          /* @__PURE__ */ jsxs("p", { className: "mb-2", children: [
            "L\xE4gg till f\xF6ljande i din ",
            /* @__PURE__ */ jsx("code", { className: "bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded", children: ".env.local" }),
            " fil:"
          ] }),
          /* @__PURE__ */ jsx("pre", { className: "bg-slate-100 dark:bg-slate-700 p-2 rounded text-xs overflow-x-auto", children: `# Google PageSpeed Insights (OBLIGATORISK)
...
GSC_REFRESH_TOKEN=xxx` }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 p-3 rounded-lg", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-semibold text-foreground mb-2", children: "2. Konfigurera webbplatsinst\xE4llningar" }),
          /* @__PURE__ */ jsx("p", { className: "mb-2", children: "Anv\xE4nd formul\xE4ren ovan f\xF6r att konfigurera:" }),
          /* @__PURE__ */ jsxs("ul", { className: "list-disc list-inside space-y-1 ml-2", children: [
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("strong", { children: "Site URL:" }),
              " Din huvudwebbplats (t.ex. https://example.com)"
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("strong", { children: "Sitemap URL:" }),
              " Valfritt - l\xE4mna tom f\xF6r auto-uppt\xE4ckt"
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("strong", { children: "Max sidor per run:" }),
              " Hur m\xE5nga sidor som analyseras \xE5t g\xE5ngen"
            ] }),
            /* @__PURE__ */ jsxs("li", { children: [
              /* @__PURE__ */ jsx("strong", { children: "GSC Site URL:" }),
              " Valfritt - f\xF6r Google Search Console-integration"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-slate-800 p-3 rounded-lg", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-semibold text-foreground mb-2", children: "3. L\xE4gg till sidor och nyckelord" }),
          /* @__PURE__ */ jsxs("ul", { className: "list-disc list-inside space-y-1 ml-2", children: [
            /* @__PURE__ */ jsx("li", { children: 'Anv\xE4nd "Hantera sidor" f\xF6r att l\xE4gga till specifika sidor att \xF6vervaka' }),
            /* @__PURE__ */ jsx("li", { children: 'Anv\xE4nd "Hantera nyckelord" f\xF6r att l\xE4gga till viktiga keywords per sida' }),
            /* @__PURE__ */ jsx("li", { children: "Dessa kommer anv\xE4ndas vid n\xE4sta analys-k\xF6rning" })
          ] })
        ] })
      ] })
    ] }) })
...
function Sidebar({ activeTab, onTabChange }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-full w-64 flex-col border-r bg-card", children: [
    /* @__PURE__ */ jsxs("div", { className: "border-b px-6 py-5", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent", children: "\u{1F916} SEO Manager" }),
      /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "AI-Driven Analytics" })
    ] }),
    /* @__PURE__ */ jsx(ScrollArea, { className: "flex-1 px-3 py-4", children: /* @__PURE__ */ jsx("nav", { className: "space-y-1", children: navItems.map((item) => {
    ...
    /* @__PURE__ */ jsx("div", { className: "border-t px-4 py-3", children: /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground text-center", children: "Powered by OpenAI & Google" }) })
  ] });
}
function Select(_a) {
...
function SuggestionsList() {
  ...
  const getImpactBadge = (impact) => {
    const variants = {
      ...
      medium: { variant: "default", icon: TrendingUp },
      low: { variant: "secondary", icon: TrendingDown }
    };
    const config = variants[impact];
    const Icon2 = config.icon;
    return /* @__PURE__ */ jsxs(Badge, { variant: config.variant, className: "gap-1", children: [
  ...
  const getStatusBadge = (status) => {
    ...
    return /* @__PURE__ */ jsx(Badge, { variant: variants[status], children: status.replace("_", " ").toUpperCase() });
  };
  if (loading) {
    return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsx(CardDescription, { children: "High Impact" }),
        /* @__PURE__ */ jsxs(CardTitle, { className: "text-4xl flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsx(CardDescription, { children: "Medium Impact" }),
        /* @__PURE__ */ jsxs(CardTitle, { className: "text-4xl flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(TrendingUp, { className: "h-8 w-8 text-yellow-600" }),
          suggestionsByImpact.medium.length
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsx(CardDescription, { children: "Low Impact" }),
        /* @__PURE__ */ jsxs(CardTitle, { className: "text-4xl flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(TrendingDown, { className: "h-8 w-8 text-blue-600" }),
          suggestionsByImpact.low.length
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsx(CardDescription, { children: "Total" }),
        /* @__PURE__ */ jsx(CardTitle, { className: "text-4xl", children: suggestions.length })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "impact-filter", children: "Impact" }),
        /* @__PURE__ */ jsxs(Select, { value: impactFilter, onValueChange: setImpactFilter, children: [
          /* @__PURE__ */ jsx(SelectTrigger, { id: "impact-filter", className: "w-[180px]", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select impact" }) }),
          /* @__PURE__ */ jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsx(SelectItem, { value: "all", children: "All Impacts" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs(Select, { value: statusFilter, onValueChange: setStatusFilter, children: [
          /* @__PURE__ */ jsx(SelectTrigger, { id: "status-filter", className: "w-[180px]", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select status" }) }),
          /* @__PURE__ */ jsxs(SelectContent, { children: [
            ...
            /* @__PURE__ */ jsx(SelectItem, { value: "dismissed", children: "Dismissed" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-4", children: suggestions.length === 0 ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(CardContent, { className: "text-center py-12 text-muted-foreground", children: "No suggestions found. Run the agent to generate suggestions." }) }) : suggestions.map((suggestion) => /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          suggestion.status === "pending" && /* @__PURE__ */ jsxs(
            Button,
            {
          ...
          suggestion.status === "in_progress" && /* @__PURE__ */ jsxs(
            Button,
            {
          ...
          suggestion.status !== "dismissed" && /* @__PURE__ */ jsxs(
            Button,
            {
      ...
      /* @__PURE__ */ jsxs(CardContent, { children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm mb-3", children: suggestion.action }),
        /* @__PURE__ */ jsxs(
          "a",
          {
            href: suggestion.url,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        ...
        /* @__PURE__ */ jsx(CardDescription, { children: "AI-genererade textf\xF6rslag f\xF6r att f\xF6rb\xE4ttra SEO" })
      ] }),
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "url-input", children: "URL att analysera" }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "url-input",
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "filter-select", children: "Filtrera f\xF6rslag" }),
            /* @__PURE__ */ jsxs(Select, { value: filter, onValueChange: (value) => setFilter(value), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { id: "filter-select", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "V\xE4lj filter" }) }),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsx(SelectItem, { value: "all", children: "Alla f\xF6rslag" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "pending", children: "V\xE4ntande" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "edited", children: "Redigerade" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxs(
            Button,
            {
              ...
              variant: "default",
              children: [
                /* @__PURE__ */ jsx("i", { className: "bi bi-arrow-clockwise me-2" }),
    ...
    !loading && suggestions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "pt-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mt-1", children: 'Klicka p\xE5 "Redigera" f\xF6r att \xE4ndra texten, eller "Till\xE4mpa" f\xF6r att markera som klar.' })
      ] }) }),
      Object.entries(grouped).map(([sectionType, sectionSuggestions]) => {
        const meta = SECTION_META[sectionType];
        if (!meta || sectionSuggestions.length === 0) return null;
        return /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx(CardHeader, { className: "bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xl", children: meta.icon }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(CardTitle, { className: "text-lg", children: meta.label }),
                /* @__PURE__ */ jsx(CardDescription, { children: meta.description })
              ] })
            ] }),
            /* @__PURE__ */ jsxs(Badge, { variant: "default", className: "bg-blue-600", children: [
              sectionSuggestions.length,
              " f\xF6rslag"
            ] })
          ] }) }),
          /* @__PURE__ */ jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsx("div", { className: "divide-y", children: sectionSuggestions.map((suggestion) => {
            const isEditing = editingId === suggestion.id;
            const displayText = suggestion.edited_text || suggestion.suggested_text;
            return /* @__PURE__ */ jsxs("div", { className: "p-6 hover:bg-muted/50 transition-colors", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mb-4", children: [
                getImpactBadge(suggestion.impact),
                getStatusBadge(suggestion.status),
                suggestion.seo_score_impact && /* @__PURE__ */ jsxs(Badge, { variant: "default", className: "bg-green-600 hover:bg-green-700", children: [
                  "+",
                  suggestion.seo_score_impact,
                  " po\xE4ng"
                ] })
              ] }),
              suggestion.original_text && /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsx(Label, { className: "mb-2 block", children: "Nuvarande text:" }),
                /* @__PURE__ */ jsx(Alert, { variant: "destructive", className: "bg-red-50 dark:bg-red-950", children: /* @__PURE__ */ jsxs(AlertDescription, { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsx(Label, { className: "mb-2 block", children: suggestion.edited_text ? "Din redigerade text:" : "F\xF6reslagen text:" }),
                ...
                ) : /* @__PURE__ */ jsx(Alert, { className: "bg-green-50 dark:bg-green-950 border-green-200", children: /* @__PURE__ */ jsxs(AlertDescription, { children: [
                  displayText,
                  /* @__PURE__ */ jsxs("div", { className: "text-xs text-muted-foreground mt-1", children: [
                    displayText.length,
                    " tecken, ",
                    ...
                    " ord",
                    suggestion.readability_score && /* @__PURE__ */ jsxs("span", { className: "ml-3", children: [
                      "\u2022 L\xE4sbarhet: ",
              ...
              /* @__PURE__ */ jsx(Alert, { className: "mb-4 bg-blue-50 dark:bg-blue-950 border-l-4 border-blue-400", children: /* @__PURE__ */ jsxs(AlertDescription, { children: [
                /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "Varf\xF6r:" }),
                " ",
                suggestion.reason
              ] }) }),
              suggestion.keywords && Array.isArray(suggestion.keywords) && suggestion.keywords.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsxs(Label, { className: "mb-2 flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Hash, { className: "h-4 w-4" }),
                  "Inkluderade nyckelord:"
                ] }),
                /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: suggestion.keywords.map((keyword, idx) => /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-300", children: String(keyword) }, idx)) })
              ] }),
              /* @__PURE__ */ jsx(Separator, { className: "my-4" }),
              /* @__PURE__ */ jsx("div", { className: "flex gap-2 flex-wrap", children: isEditing ? /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsxs(
                  Button,
                  {
                    onClick: () => {
                ...
                /* @__PURE__ */ jsx(
                  Button,
                  {
                    ...
                    size: "sm",
                    variant: "secondary",
                    children: copySuccess === suggestion.id ? /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              suggestion.applied_at && /* @__PURE__ */ jsxs("div", { className: "mt-3 text-xs text-muted-foreground", children: [
                "Till\xE4mpades: ",
    ...
    !loading && suggestions.length === 0 && selectedUrl && /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(CardContent, { className: "py-12 text-center", children: [
      /* @__PURE__ */ jsx("i", { className: "bi bi-lightbulb text-6xl text-muted-foreground mb-4 d-block" }),
      /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold mb-2", children: "Inga f\xF6rslag \xE4n" }),
      /* @__PURE__ */ jsx("p", { className: "text-muted-foreground mb-6", children: "Generera textf\xF6rslag f\xF6r denna sida genom att klicka p\xE5 knappen ovan." })
    ] }) })
  ] });
}
function Dialog(_a) {
...
async function psiAudit(url, apiKey, strategy = "mobile") {
  try {
    ...
    const response = await axios3.get(apiUrl.toString(), {
      timeout: 6e4
      // 60 sekunder
    });
...
async function gscTopQueries(siteUrl, accessToken, startDate, endDate, rowLimit = 1e3) {
  try {
    ...
    const response = await axios3.post(apiUrl, requestBody, {
      headers: {
...
async function refreshGSCToken(refreshToken, clientId, clientSecret) {
  try {
    const response = await axios3.post("https://oauth2.googleapis.com/token", {
      client_id: clientId,
